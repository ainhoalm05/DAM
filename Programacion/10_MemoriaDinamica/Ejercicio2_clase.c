...
int main() {
    ...
    int * arr = (int *) malloc(5*sizeof(int)); // Reserva 5 espacios de la memoria, y no la toca
    ...
    /**LO MISMO CON CALLOC */
    int * arr2 = (int *) calloc(5,sizeof(int)); // Reserva 5 espacios de la memoria e inicializa a 0
    if (arr2 == NULL){
        printf("Error: no se pudo asignar memoria\n");
        return EXIT_FAILURE;
    }
